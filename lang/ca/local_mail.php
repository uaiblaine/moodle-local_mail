...
$string['configquicksearchlimit'] = 'Límit de cerca ràpida';
$string['configquicksearchlimitdesc'] = 'Estableix el nombre màxim de missatges recents inclosos a les cerques ràpides. Augmentar aquest nombre pot tenir un impacte negatiu al rendiment de la base de dades.';
