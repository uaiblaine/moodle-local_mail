...
$string['configcoursebadgeslengthdesc'] = 'Truncate course badges displayed in messages to this number of characters (aproximately).';
...
$string['configcoursetraysnamedesc'] = 'Sets the type of course name to display in menus.';
...
$string['configglobaltraysdesc'] = 'Sets whichs global trays are displayed in menus. Inbox is always displayed.';
...
$string['inbox'] = 'Inbox';
$string['invalidlabel'] = 'Label not found';
$string['invalidmessage'] = 'Message not found';
