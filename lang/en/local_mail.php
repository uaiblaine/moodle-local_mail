...
$string['configmaxattachments'] = 'Maximum number of attachments';
$string['configmaxattachmentsize'] = 'Maximum attachment size';
$string['configquicksearchlimit'] = 'Quick search limit';
$string['configquicksearchlimitdesc'] = 'Sets the maximum number of recent messages included in quick searches. Increasing this number can have a negative impact on database performance.';
...
$string['errorinvalidrecipientrole'] = 'Invalid recipient type';
...
$string['searchall'] = 'Search all messages';
...
$string['undodeleteone'] = 'A message have been moved to trash';
$string['undorestoremany'] = '{$a} messages have been restored';
$string['undorestoreone'] = 'A message have been restored';
