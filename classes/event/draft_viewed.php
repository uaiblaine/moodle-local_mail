...
/**
 * Event triggered when a user opens a draft message.
 *
 * @package    local_mail
...
class draft_viewed extends \core\event\base {
    /**
     * Builds the event for a viewed draft, in the context of the current user.
     *
     * @param \local_mail\message $message The draft that has just been viewed.
