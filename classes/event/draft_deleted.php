...
/**
 * Event triggered when a user deletes a draft message.
 *
 * @package    local_mail
...
class draft_deleted extends \core\event\base {
    /**
     * Builds the event for a deleted draft, in the context of the current user.
     *
     * @param \local_mail\message $message The draft that has just been deleted.
