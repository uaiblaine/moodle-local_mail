...
/**
 * Event triggered when a user opens a message that has been sent.
 *
 * @package    local_mail
...
class message_viewed extends \core\event\base {
    /**
     * Builds the event for a viewed message, in the context of the course of the message.
     *
     * @param \local_mail\message $message The message that has just been viewed.
