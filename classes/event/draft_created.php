...
/**
 * Event triggered when a user creates a draft message.
 *
 * @package    local_mail
...
class draft_created extends \core\event\base {
    /**
     * Builds the event for a newly created draft, in the context of the current user.
     *
     * @param \local_mail\message $message The draft that has just been created.
